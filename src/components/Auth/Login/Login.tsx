  ...
  return (
    <div className="login-container">
      ...
      <div className="login-card">
        <h1 className="login-title">{otpRequired ? 'Admin 2FA Verify' : 'Admin Login'}</h1>
        <p className="login-subtitle">
          {otpRequired ? 'Authenticator app ka 6-digit OTP enter karo' : 'Sign in to access the dashboard'}
        </p>
